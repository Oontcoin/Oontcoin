...
from test_framework.test_framework import OontcoinTestFramework
...
class LLMQCoinbaseCommitmentsTest(OontcoinTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as OontcoinTestFramework doesn't support this atm)
