...
Arguments:
    <base_directory> - The base directory of a Oontcoin Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Oontcoin Core developers'
...
Arguments:
    <base_directory> - The base directory of Oontcoin Core source code repository.
"""
...
Arguments:
    <file> - A source file in the Oontcoin Core repository.
"""
