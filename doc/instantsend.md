...
This mechanism has been integrated into Bitcore-Node-Oontcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/oontcoinpay/insight-api-oontcoin#web-socket-api](https://github.com/oontcoinpay/insight-api-oontcoin#web-socket-api)
* API: [https://github.com/oontcoinpay/insight-api-oontcoin#instantsend-transactions](https://github.com/oontcoinpay/insight-api-oontcoin#instantsend-transactions)
