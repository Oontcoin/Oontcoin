...
This document provides guidelines for internationalization of the Oontcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `oontcoin_en.ts` remains unchanged.
