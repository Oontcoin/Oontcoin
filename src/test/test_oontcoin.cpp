...
#define BOOST_TEST_MODULE Oontcoin Test Suite

#include "test_oontcoin.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_oontcoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
