...
// Copyright (c) 2021 The Oontcoin Core developers
 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1612464310, nBits=1e0ffff0, nNonce=110979, vtx=1)
...
{
    const char* pszTimestamp = "The times 04feb21 i create the idea of a new coin";
    const CScript genesisOutputScript = CScript() << ParseHex("04e904f96c4ec03672e0417dfe2f5169ff1bd3ba869623819a79879edc362c53242b2b98d4cdf9b38d78fdf9017f303ed062a5582153c98242525eb51b3b8b856a") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x00000c44791aa519c878b9a392ea831e4cdfd129fd911d3d81b4d6da4af4dc18"); 
        ...
        vAlertPubKey = ParseHex("040d222a417135d56bedd4385f1e06905487c6801c49e4388a4dc7e3ddf88bf77c7ec7e2f27718fa8fd42dfb9dcf399ae304a1fadcdc80e24dd568d205bc117f70");
        nDefaultPort = 28786;
        nPruneAfterHeight = 100000;

        genesis = CreateGenesisBlock(1612464310, 110979, 0x1e0ffff0, 1, 100 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000c44791aa519c878b9a392ea831e4cdfd129fd911d3d81b4d6da4af4dc18"));
        assert(genesis.hashMerkleRoot == uint256S("0x6a7f057ece826a8eb5ee2f27869046646950b04bf7c1dcbf18bff9523a3ff9bb"));
        ...
        // Oontcoin BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // Oontcoin BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // Oontcoin BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"8HPxR9ZuFM3NoTEMFx1GLySdBnpbBxCdJF"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (  0, uint256S("0x00000c44791aa519c878b9a392ea831e4cdfd129fd911d3d81b4d6da4af4dc18"))
        };

        chainTxData = ChainTxData{
            1612464310, // * UNIX timestamp of last known number of transactions (Block 1068571)
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x000008f40cd572feb3a64c2abdcf76a3e2356b6dbcf8951ea2f5e226aa232ade"); 

        pchMessageStart[0] = 0x3d;
        pchMessageStart[1] = 0x05;
        pchMessageStart[2] = 0xd2;
        pchMessageStart[3] = 0x15;
        vAlertPubKey = ParseHex("045e5944e15d3ebbc2a1eacfd6b2d7f5c5cae8cb6838ce9b4460667ac2f6fe97cc61b703633377009185e1d30a485eaa9ae3ad8ecc5847390062093aca1d442a38");
        nDefaultPort = 38786;
        nPruneAfterHeight = 1000;

        genesis = CreateGenesisBlock(1612464315UL, 383181UL, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x000008f40cd572feb3a64c2abdcf76a3e2356b6dbcf8951ea2f5e226aa232ade"));
        assert(genesis.hashMerkleRoot == uint256S("0x6a7f057ece826a8eb5ee2f27869046646950b04bf7c1dcbf18bff9523a3ff9bb"));
        ...
        // Testnet Oontcoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet Oontcoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet Oontcoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"CXhiLiWq2vywpaq1cS3BDWRBvhZs1m4wLi"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (    0, uint256S("0x000008f40cd572feb3a64c2abdcf76a3e2356b6dbcf8951ea2f5e226aa232ade"))
        };

        chainTxData = ChainTxData{
            1612464315, // * UNIX timestamp of last known number of transactions (Block 96717)
            0,     // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0        // * estimated number of transactions per second after that timestamp
        };
...
public:
    CDevNetParams() {
        ...
        genesis = CreateGenesisBlock(1612464320, 0, 0x207fffff, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00a3770ad3836648e992f9bb594385759bc9a6c2f9c7f96b0b7d9575af5de729"));
        assert(genesis.hashMerkleRoot == uint256S("0x6a7f057ece826a8eb5ee2f27869046646950b04bf7c1dcbf18bff9523a3ff9bb"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("oontcoinevo.org",  "devnet-seed.oontcoinevo.org"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (      0, uint256S("0x00a3770ad3836648e992f9bb594385759bc9a6c2f9c7f96b0b7d9575af5de729"))
...
public:
    CRegTestParams() {
        ...
        // privKey: 6EcvAJN2AmMox1FnEhovwDfb9qB6AZ3imnDGMyYFfds8ZhF2k7v
        vSporkAddresses = {"CWAWLW7ouVbo5Q9eaPUp1KMAPGFBjru6V8"};
        nMinSporkKeys = 1;
        ...
        // Regtest Oontcoin addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,28);
        // Regtest Oontcoin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,29);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,156);
        // Regtest Oontcoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest Oontcoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest Oontcoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
