...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner Oontcoin address\n"
            "  payee          - Print the masternode payout Oontcoin address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting Oontcoin address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "oontcoin",               "masternode",             &masternode,             true,  {} },
    { "oontcoin",               "masternodelist",         &masternodelist,         true,  {} },
    { "oontcoin",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "oontcoin",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
