...
//! These need to be macros, as clientversion.cpp's and oontcoin*-res.rc's voodoo requires it
...
/**
 * oontcoind-res.rc includes this file, but it cannot cope with real c++ code.
